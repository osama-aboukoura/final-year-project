...
urlpatterns = [
    ...
    url(r'^resend-username/$', views.resend_username, name='resend_username'),
    ...
    url(r'^delete-profile/$', views.deleteProfileAndUser, name='delete-profile'),    
    url(r'^delete-profile-confirm/$', views.deleteProfileAndUserConfirm, name='delete-profile-confirm'),    
